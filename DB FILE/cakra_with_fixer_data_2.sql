...
CREATE TABLE `mst_work_units`  (
  ...
  `work_unit_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `work_unit_parent_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `work_unit_code` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `work_unit_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `work_unit_sort` int NULL DEFAULT NULL,
  `work_unit_create_by` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `work_unit_create_date` datetime NULL DEFAULT NULL,
  `work_unit_update_by` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `work_unit_update_date` datetime NULL DEFAULT NULL,
  `work_unit_log_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `sys_access`  (
  ...
  `access_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `access_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `access_is_admin` int NULL DEFAULT NULL,
  `access_create_by` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `access_create_date` datetime NULL DEFAULT NULL,
  `access_update_by` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `sys_access_detail`  (
  ...
  `access_detail_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `access_detail_access_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `access_detail_menu_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  ...
  `access_detail_create_by` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `access_detail_create_date` datetime NULL DEFAULT NULL,
  `access_detail_update_by` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `access_detail_update_date` datetime NULL DEFAULT NULL,
  `access_detail_log_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `sys_menus`  (
  ...
  `menu_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `menu_parent_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  ...
  `menu_controller` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `menu_folder` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `menu_icon` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `menu_sort` int NULL DEFAULT NULL,
  `menu_create_by` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `menu_create_date` datetime NULL DEFAULT NULL,
  `menu_update_by` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `sys_users`  (
  ...
  `user_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `user_fullname` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  ...
  `user_create_by` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `user_create_date` datetime NULL DEFAULT NULL,
  `user_update_by` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `user_update_date` datetime NULL DEFAULT NULL,
  `user_log_uuid` int NULL DEFAULT NULL,
  `user_status` int NULL DEFAULT NULL,
  `user_access_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `trx_apk`  (
  ...
  `apk_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `apk_year` int NULL DEFAULT NULL,
  `apk_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `apk_sort` int NULL DEFAULT NULL,
  `apk_create_by` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `apk_create_date` datetime NULL DEFAULT NULL,
  `apk_status` int NULL DEFAULT NULL,
  `apk_log_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `trx_budgets`  (
  ...
  `budget_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `budget_year` int NULL DEFAULT NULL,
  `budget_month` int NULL DEFAULT NULL,
  `budget_work_program_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `budget_plafon` decimal(12, 0) NULL DEFAULT NULL,
  `budget_realization` decimal(12, 0) NULL DEFAULT NULL,
  `budget_create_by` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `budget_create_date` datetime NULL DEFAULT NULL,
  `budget_status` int NULL DEFAULT NULL,
  `budget_log_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `trx_dashboard_realisasi`  (
  ...
  `dashboard_realisasi_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `dashboard_realisasi_year` int NULL DEFAULT NULL,
  `dashboard_realisasi_revision_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  ...
  `dashboard_realisasi_create_by` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `dashboard_realisasi_create_date` datetime NULL DEFAULT NULL,
  `dashboard_realisasi_status` int NULL DEFAULT NULL,
  `dashboard_realisasi_log_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `trx_dashboard_realisasi` VALUES (1, '770f14a9-f852-49c0-a1a6-0e1e7e7d26cf', 2024, 'DIPA INDUK', 21773786000, 34812394000, 149640000, 1, '9a5c787a-597c-11ee-8476-f4a4757ae8c3', '2024-12-18 16:39:50', 1, NULL, 56735820000);
INSERT INTO `trx_dashboard_realisasi` VALUES (2, 'e230acdc-0678-4fee-9a8d-23380f35d2c1', 2024, 'DIPA', 19773786000, 30812394000, 6149640000, 1, '9a5c787a-597c-11ee-8476-f4a4757ae8c3', '2024-12-18 16:40:20', 0, 'e230acdc-0678-4fee-9a8d-23380f35d2c1', 56735820000);
...
CREATE TABLE `trx_indikator_kinerja`  (
  ...
  `indikator_kinerja_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `indikator_kinerja_sasaran_strategis_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `indikator_kinerja_biro_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `indikator_kinerja_sort` int NULL DEFAULT NULL,
  `indikator_kinerja_name` varchar(4000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `indikator_kinerja_satuan` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `indikator_kinerja_target` decimal(12, 2) NULL DEFAULT NULL,
  `indikator_kinerja_realisasi` decimal(12, 2) NULL DEFAULT NULL,
  `indikator_kinerja_create_by` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `indikator_kinerja_create_date` datetime NULL DEFAULT NULL,
  `indikator_kinerja_status` int NULL DEFAULT NULL,
  `indikator_kinerja_log_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `trx_indikator_kinerja` VALUES (18, 'fbe18e19-11d9-48b6-9ae5-58273c05fbcf', 'b449ab24-e8bf-4054-ad89-1b939b868851', NULL, NULL, 'Rumusan Kebijakan/Strategi Peningkatan Ketahanan Energi Nasional (Rumusan Rekomendasi)', 'Jumlah', 1.00, 1.00, '9a5c787a-597c-11ee-8476-f4a4757ae8c3', '2024-12-18 17:57:30', 1, NULL);
INSERT INTO `trx_indikator_kinerja` VALUES (19, '98f76a0e-1b09-44fc-a5ab-d32b701fc316', '1bccca4b-9e3e-48c5-9268-3c06291b8a26', NULL, NULL, 'Indeks Kepuasan Layanan Dukungan Teknis dan Administratif yang Optimal Setjen DEN (Indeks Skala 4)', 'Indeks', 3.20, 3.27, '9a5c787a-597c-11ee-8476-f4a4757ae8c3', '2024-12-18 17:58:12', 1, NULL);
INSERT INTO `trx_indikator_kinerja` VALUES (20, 'c23318e5-e55e-4a6c-861d-974b1ddfd036', '662b2d66-1144-4516-b2c9-07077698a03e', NULL, NULL, 'lndeks Kepuasan Layanan Perencanaan Energi (lndeks Skala 4)', 'Indeks', 3.45, 3.59, '9a5c787a-597c-11ee-8476-f4a4757ae8c3', '2024-12-18 17:58:35', 1, NULL);
INSERT INTO `trx_indikator_kinerja` VALUES (21, '7f8a09e5-d028-4b5a-8991-0d6e2db86270', '2fe44a04-2712-4005-9b86-c5e74892a5ef', NULL, NULL, 'Rumusan Rekomendasi Kebijakan Energi Lintas Sektor Hasil Koordinasi dan Sinkronisasi antara lain RUED (Rumusan Rekomendasi)', 'Jumlah', 8.00, 8.00, '9a5c787a-597c-11ee-8476-f4a4757ae8c3', '2024-12-18 17:59:00', 1, NULL);
INSERT INTO `trx_indikator_kinerja` VALUES (22, 'faff5859-17d5-45be-aeea-563ce618c6c5', '2fe44a04-2712-4005-9b86-c5e74892a5ef', NULL, NULL, 'Jumlah Penyiapan Persidangan DEN', 'Jumlah', 8.00, 8.00, '9a5c787a-597c-11ee-8476-f4a4757ae8c3', '2024-12-18 18:00:39', 1, NULL);
INSERT INTO `trx_indikator_kinerja` VALUES (23, '7ca6b508-dc14-412a-818c-416211541a4b', '2fe44a04-2712-4005-9b86-c5e74892a5ef', NULL, NULL, 'Rumusan Perencanaan Energi yang Bersifat Lintas Sektoral (Buku Outlook Energi Indonesia dan Buku Neraca Energi Indonesia)', 'Jumlah', 2.00, 2.00, '9a5c787a-597c-11ee-8476-f4a4757ae8c3', '2024-12-18 18:01:00', 1, NULL);
INSERT INTO `trx_indikator_kinerja` VALUES (24, '9f183380-1a48-4f27-ad89-d6ab63cc2e9b', '2fe44a04-2712-4005-9b86-c5e74892a5ef', NULL, NULL, 'Persentase Produk Hukum yang Ditindaklanjuti (Amanah regulasi dan sosialisasi)', 'Persentase', 100.00, 100.00, '9a5c787a-597c-11ee-8476-f4a4757ae8c3', '2024-12-18 18:01:07', 1, NULL);
INSERT INTO `trx_indikator_kinerja` VALUES (25, '24ae602c-60d2-4581-9b08-b25747f17e63', '57371ee1-4c26-499d-b1ad-73925eb75fee', NULL, NULL, 'Evaluasi Pencapaian Bauran Energi Primer Nasional (Rumusan Hasil Pengawasan)', 'Rumusan', 1.00, 2.00, '9a5c787a-597c-11ee-8476-f4a4757ae8c3', '2024-12-18 18:04:47', 1, NULL);
INSERT INTO `trx_indikator_kinerja` VALUES (26, '42c0716e-ed9b-481d-b939-252fd8ab4c1b', '57371ee1-4c26-499d-b1ad-73925eb75fee', NULL, NULL, 'Evaluasi Pencapaian Bauran Energi Primer Daerah (Rumusan Rekomendasi)', 'Rumusan', 30.00, 31.00, '9a5c787a-597c-11ee-8476-f4a4757ae8c3', '2024-12-18 18:04:54', 1, NULL);
INSERT INTO `trx_indikator_kinerja` VALUES (27, '058b9b74-3e68-49d1-a68a-cccfed03822c', '57371ee1-4c26-499d-b1ad-73925eb75fee', NULL, NULL, 'Monitoring Implementasi Matriks Kegiatan RUEN (Monitoring Kegiatan)', 'Jumlah', 200.00, 310.00, '9a5c787a-597c-11ee-8476-f4a4757ae8c3', '2024-12-18 18:05:39', 1, NULL);
INSERT INTO `trx_indikator_kinerja` VALUES (28, '3b4c877a-b8ce-4ffd-b904-1d95f804e4f9', '57887955-91e2-48af-8251-23ee480bd4c9', NULL, NULL, 'Nilai SAKIP Setjen DEN (Nilai Skala 100)', 'Nilai', 84.10, 80.50, '9a5c787a-597c-11ee-8476-f4a4757ae8c3', '2024-12-18 18:06:19', 1, NULL);
INSERT INTO `trx_indikator_kinerja` VALUES (29, '588f0284-2038-4911-b219-118d638d70b8', '57887955-91e2-48af-8251-23ee480bd4c9', NULL, NULL, 'Tingkat Maturitas SPIP Setjen DEN (Level)', 'Level', 3.65, 3.71, '9a5c787a-597c-11ee-8476-f4a4757ae8c3', '2024-12-18 18:07:37', 1, NULL);
INSERT INTO `trx_indikator_kinerja` VALUES (30, '9193b673-9802-4836-9482-98297a783085', 'c2ee7a35-2a75-4ee9-878d-b40585d31833', NULL, NULL, 'Indeks Reformasi Birokrasi Setjen DEN (Nilai)', 'Nilai', 91.00, 91.00, '9a5c787a-597c-11ee-8476-f4a4757ae8c3', '2024-12-18 18:20:10', 1, NULL);
INSERT INTO `trx_indikator_kinerja` VALUES (31, '3f5a1b16-aec3-49a0-a876-fe5793263780', '3a87c979-0d61-44bb-b0db-635ffe2081cc', NULL, NULL, 'Indeks Profesionalitas ASN Setjen DEN (Indeks Skala 100)', 'Indeks', 82.00, 83.58, '9a5c787a-597c-11ee-8476-f4a4757ae8c3', '2024-12-18 18:08:49', 1, NULL);
INSERT INTO `trx_indikator_kinerja` VALUES (32, 'd4ec20bd-a27c-444e-8dae-3ae293a12dd0', '3a87c979-0d61-44bb-b0db-635ffe2081cc', NULL, NULL, 'Nilai Evaluasi Kelembagaan Setjen DEN (Nilai Skala 100)', 'Nilai', 75.00, 75.03, '9a5c787a-597c-11ee-8476-f4a4757ae8c3', '2024-12-18 18:16:56', 1, NULL);
INSERT INTO `trx_indikator_kinerja` VALUES (33, '7bfa64ad-65e4-4db1-b1ff-ac1383f6bd03', '72f38eb8-8bdd-4fe2-adc1-bcb6309ed209', NULL, NULL, 'Nilai Indikator Kinerja Pelaksanaan Anggaran (IKPA) Setjen DEN (Nilai Skala 100)', 'Nilai', 95.00, 94.05, '9a5c787a-597c-11ee-8476-f4a4757ae8c3', '2024-12-18 18:17:23', 1, NULL);
...
CREATE TABLE `trx_program_apk`  (
  ...
  `program_apk_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `program_apk_apk_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `program_apk_year` int NULL DEFAULT NULL,
  `program_apk_month` int NULL DEFAULT NULL,
  `program_apk_urian` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `program_apk_pagu` decimal(12, 2) NULL DEFAULT NULL,
  `program_apk_realisasi` decimal(12, 2) NULL DEFAULT NULL,
  `program_apk_create_by` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `program_apk_create_date` datetime NULL DEFAULT NULL,
  `program_apk_status` int NULL DEFAULT NULL,
  `program_apk_log_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `trx_realisasi_apk`  (
  ...
  `realisasi_apk_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `realisasi_apk_apk_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `realisasi_apk_year` int NULL DEFAULT NULL,
  `realisasi_apk_month` int NULL DEFAULT NULL,
  `realisasi_apk_urian` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `realisasi_apk_pagu` decimal(12, 2) NULL DEFAULT NULL,
  `realisasi_apk_realisasi` decimal(12, 2) NULL DEFAULT NULL,
  `realisasi_apk_create_by` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `realisasi_apk_create_date` datetime NULL DEFAULT NULL,
  `realisasi_apk_status` int NULL DEFAULT NULL,
  `realisasi_apk_log_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `trx_realisasi_iku`  (
  ...
  `realisasi_iku_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `realisasi_iku_indikator_kinerja_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `realisasi_iku_target` decimal(12, 2) NULL DEFAULT NULL,
  `realisasi_iku_realisasi` decimal(12, 2) NULL DEFAULT NULL,
  `realisasi_iku_create_by` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `realisasi_iku_create_date` datetime NULL DEFAULT NULL,
  `realisasi_iku_status` int NULL DEFAULT NULL,
  `realisasi_iku_log_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `trx_sasaran_strategis`  (
  ...
  `sasaran_strategis_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `sasaran_strategis_year` int NULL DEFAULT NULL,
  `sasaran_strategis_name` varchar(4000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `sasaran_strategis_sort` int NULL DEFAULT NULL,
  `sasaran_strategis_create_by` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `sasaran_strategis_create_date` datetime NULL DEFAULT NULL,
  `sasaran_strategis_status` int NULL DEFAULT NULL,
  `sasaran_strategis_log_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `trx_sasaran_strategis` VALUES (18, 'b449ab24-e8bf-4054-ad89-1b939b868851', 2024, 'Meningkatnya Kemandiran dan Ketahanan Energi Nasional', NULL, '9a5c787a-597c-11ee-8476-f4a4757ae8c3', '2024-12-18 17:50:50', 1, NULL);
INSERT INTO `trx_sasaran_strategis` VALUES (19, '1bccca4b-9e3e-48c5-9268-3c06291b8a26', 2024, 'Layanan Dukungan Teknis dan Administratif yang Optimal Setjen DEN', NULL, '9a5c787a-597c-11ee-8476-f4a4757ae8c3', '2024-12-18 17:51:46', 1, NULL);
INSERT INTO `trx_sasaran_strategis` VALUES (20, '662b2d66-1144-4516-b2c9-07077698a03e', 2024, 'Layanan Penyusunan Rancangan Perencanaan Energi Lintas Sektor yang Berkelanjutan', NULL, '9a5c787a-597c-11ee-8476-f4a4757ae8c3', '2024-12-18 17:51:56', 1, NULL);
INSERT INTO `trx_sasaran_strategis` VALUES (21, '2fe44a04-2712-4005-9b86-c5e74892a5ef', 2024, 'Merumuskan Kebijakan Energi dan Menyusun Perencanaan Energi yang Bersifat Lintas Sektor Serta Kehumasan dan Persidangan DEN', NULL, '9a5c787a-597c-11ee-8476-f4a4757ae8c3', '2024-12-18 17:52:04', 1, NULL);
INSERT INTO `trx_sasaran_strategis` VALUES (22, '57371ee1-4c26-499d-b1ad-73925eb75fee', 2024, 'Melaksanakan Pengawasan Implementasi Kebijakan Energi yang Bersifat Lintas Sektoral', NULL, '9a5c787a-597c-11ee-8476-f4a4757ae8c3', '2024-12-18 17:52:12', 1, NULL);
INSERT INTO `trx_sasaran_strategis` VALUES (23, '57887955-91e2-48af-8251-23ee480bd4c9', 2024, 'Terselenggaranya Monitoring dan Evaluasi Kinerja Organisasi Setjen DEN', NULL, '9a5c787a-597c-11ee-8476-f4a4757ae8c3', '2024-12-18 17:52:20', 1, NULL);
INSERT INTO `trx_sasaran_strategis` VALUES (24, 'c2ee7a35-2a75-4ee9-878d-b40585d31833', 2024, 'Terwujudnya Birokrasi Setjen DEN yang Efektif, Efisien, dan Berorientasi Pada Layanan Prima', NULL, '9a5c787a-597c-11ee-8476-f4a4757ae8c3', '2024-12-18 17:52:29', 1, NULL);
INSERT INTO `trx_sasaran_strategis` VALUES (25, '3a87c979-0d61-44bb-b0db-635ffe2081cc', 2024, 'Organisasi Setjen DEN yang Fit dan SDM yang Unggul', NULL, '9a5c787a-597c-11ee-8476-f4a4757ae8c3', '2024-12-18 17:52:38', 1, NULL);
INSERT INTO `trx_sasaran_strategis` VALUES (26, '72f38eb8-8bdd-4fe2-adc1-bcb6309ed209', 2024, 'Pengelolaan Sistem Anggaran Setjen DEN yang Optimal', NULL, '9a5c787a-597c-11ee-8476-f4a4757ae8c3', '2024-12-18 17:52:51', 1, NULL);
...
CREATE TABLE `trx_sppd`  (
  ...
  `sppd_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `sppd_year` int NULL DEFAULT NULL,
  `sppd_month` int NULL DEFAULT NULL,
  `sppd_work_unit_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `sppd_pegawai` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `sppd_barang` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `sppd_modal` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `sppd_create_by` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `sppd_create_date` datetime NULL DEFAULT NULL,
  `sppd_status` int NULL DEFAULT NULL,
  `sppd_log_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `trx_target`  (
  ...
  `target_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `target_work_unit_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  ...
  `target_create_by` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `target_create_date` datetime NULL DEFAULT NULL,
  `target_status` int NULL DEFAULT NULL,
  `target_log_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `trx_target` VALUES (8, 'f561d585-528a-4ff7-8774-5022defc97f8', '261b36ee-5a41-11ee-971e-f4a4757ae8c3', 2024, NULL, NULL, NULL, 1.6300000000, 8.3100000000, 19.5900000000, 25.5900000000, 38.4700000000, 49.9000000000, 57.4700000000, 65.2400000000, 73.3300000000, 80.8100000000, 88.5000000000, 99.0100000000, '9a5c787a-597c-11ee-8476-f4a4757ae8c3', '2024-12-18 17:25:56', 1, NULL);
INSERT INTO `trx_target` VALUES (9, 'd2d86e12-dc3c-4ce5-bf86-959aec987c19', '261b373f-5a41-11ee-971e-f4a4757ae8c3', 2024, NULL, NULL, NULL, 1.5400000000, 7.8900000000, 19.7700000000, 25.6700000000, 38.7800000000, 49.8900000000, 57.3400000000, 64.8900000000, 72.9500000000, 80.3400000000, 88.0600000000, 98.8300000000, '9a5c787a-597c-11ee-8476-f4a4757ae8c3', '2024-12-18 17:25:56', 1, NULL);
INSERT INTO `trx_target` VALUES (10, '8dfa0219-78f6-4953-8552-21532c32e17b', '261b3744-5a41-11ee-971e-f4a4757ae8c3', 2024, NULL, NULL, NULL, 2.3600000000, 12.1000000000, 19.8800000000, 24.7000000000, 36.7000000000, 49.6800000000, 56.9500000000, 64.0800000000, 72.5000000000, 79.8900000000, 88.9900000000, 99.9200000000, '9a5c787a-597c-11ee-8476-f4a4757ae8c3', '2024-12-18 17:25:56', 1, NULL);
INSERT INTO `trx_target` VALUES (11, 'b3decd7d-7ec2-4c2e-9fce-287f03d71fc4', '261b3748-5a41-11ee-971e-f4a4757ae8c3', 2024, NULL, NULL, NULL, 1.8500000000, 8.2800000000, 17.0000000000, 25.8400000000, 37.0700000000, 50.2700000000, 59.7500000000, 71.1400000000, 79.0500000000, 87.7500000000, 93.2300000000, 99.9300000000, '9a5c787a-597c-11ee-8476-f4a4757ae8c3', '2024-12-18 17:25:56', 1, NULL);
...
CREATE TABLE `trx_upload`  (
  ...
  `upload_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `upload_type` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `upload_file_path` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `upload_create_by` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `upload_create_date` datetime NULL DEFAULT NULL,
  `upload_status` int NULL DEFAULT NULL,
  `upload_log_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `trx_upload_apk`  (
  ...
  `upload_apk_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `upload_apk_year` int NULL DEFAULT NULL,
  `upload_apk_month` int NULL DEFAULT NULL,
  `upload_apk_nama` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `upload_apk_ket` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  ...
  `upload_apk_create_by` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `upload_apk_create_date` datetime NULL DEFAULT NULL,
  `upload_apk_status` int NULL DEFAULT NULL,
  `upload_apk_log_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `trx_upload_belanja`  (
  ...
  `upload_belanja_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `upload_belanja_year` int NULL DEFAULT NULL,
  `upload_belanja_month` int NULL DEFAULT NULL,
  `upload_belanja_nama` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  ...
  `upload_belanja_create_by` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `upload_belanja_create_date` datetime NULL DEFAULT NULL,
  `upload_belanja_status` int NULL DEFAULT NULL,
  `upload_belanja_log_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `trx_upload_nilai_program`  (
  ...
  `upload_nilai_program_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `upload_nilai_program_year` int NULL DEFAULT NULL,
  `upload_nilai_program_month` int NULL DEFAULT NULL,
  `upload_nilai_program_work_program_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  ...
  `upload_nilai_program_create_by` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `upload_nilai_program_create_date` datetime NULL DEFAULT NULL,
  `upload_nilai_program_status` int NULL DEFAULT NULL,
  `upload_nilai_program_log_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`upload_nilai_program_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 209 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `trx_upload_paparan_program`  (
  ...
  `upload_paparan_program_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `upload_paparan_program_parent_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `upload_paparan_program_work_unit_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `upload_paparan_program_year` int NULL DEFAULT NULL,
  `upload_paparan_program_month` int NULL DEFAULT NULL,
  `upload_paparan_program_code` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `upload_paparan_program_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  ...
  `upload_paparan_program_create_by` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `upload_paparan_program_create_date` datetime NULL DEFAULT NULL,
  `upload_paparan_program_status` int NULL DEFAULT NULL,
  `upload_paparan_program_log_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `trx_upload_work_program`  (
  ...
  `upload_work_program_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `upload_work_program_parent_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `upload_work_program_work_unit_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `upload_work_program_year` int NULL DEFAULT NULL,
  `upload_work_program_code` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `upload_work_program_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `upload_work_program_create_by` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `upload_work_program_create_date` datetime NULL DEFAULT NULL,
  `upload_work_program_status` int NULL DEFAULT NULL,
  `upload_work_program_log_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `trx_work_programs`  (
  ...
  `work_program_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `work_program_parent_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `work_program_year` int NULL DEFAULT NULL,
  `work_program_work_unit_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `work_program_code` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `work_program_name` varchar(4400) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `work_program_is_last_child` int NULL DEFAULT NULL,
  `work_program_description` varchar(4400) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `work_program_create_by` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `work_program_create_date` datetime NULL DEFAULT NULL,
  `work_program_update_by` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `work_program_update_date` datetime NULL DEFAULT NULL,
  `work_program_log_uuid` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
...
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `view_periode_revisi` AS select `aa`.`dashboard_realisasi_uuid` AS `dashboard_realisasi_uuid`,`aa`.`dashboard_realisasi_year` AS `dashboard_realisasi_year`,concat(`aa`.`dashboard_realisasi_revision_name`,convert((case when (`aa`.`dashboard_realisasi_revision_name` <> 'DIPA INDUK') then concat(' ',`aa`.`dashboard_realisasi_version`) else '' end) using utf8mb3)) AS `jenis_revisi`,`aa`.`dashboard_realisasi_create_date` AS `dashboard_realisasi_create_date` from `trx_dashboard_realisasi` `aa` group by `aa`.`dashboard_realisasi_uuid`,`aa`.`dashboard_realisasi_revision_name`,`aa`.`dashboard_realisasi_version`,`aa`.`dashboard_realisasi_year`,`aa`.`dashboard_realisasi_create_date`;

-- ----------------------------
-- View structure for view_realisasi_by_unit
-- ----------------------------
DROP VIEW IF EXISTS `view_realisasi_by_unit`;
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `view_realisasi_by_unit` AS with recursive `category_hierarchy` as (select `a`.`upload_paparan_program_id` AS `upload_paparan_program_id`,`a`.`upload_paparan_program_uuid` AS `upload_paparan_program_uuid`,`a`.`upload_paparan_program_parent_uuid` AS `upload_paparan_program_parent_uuid`,`a`.`upload_paparan_program_work_unit_uuid` AS `upload_paparan_program_work_unit_uuid`,`a`.`upload_paparan_program_year` AS `upload_paparan_program_year`,`a`.`upload_paparan_program_month` AS `upload_paparan_program_month`,`a`.`upload_paparan_program_code` AS `upload_paparan_program_code`,`a`.`upload_paparan_program_name` AS `upload_paparan_program_name`,`a`.`upload_paparan_program_spd_pagu` AS `upload_paparan_program_spd_pagu`,`a`.`upload_paparan_program_spd_realisasi` AS `upload_paparan_program_spd_realisasi`,`a`.`upload_paparan_program_spd_target` AS `upload_paparan_program_spd_target`,`c`.`work_unit_code` AS `work_unit_code`,`c`.`work_unit_name` AS `work_unit_name`,cast('' as char(255) charset utf8mb4) AS `tabs`,cast(concat(`number_to_alphabet`(`a`.`upload_paparan_program_id`),':',`a`.`upload_paparan_program_year`,':',`a`.`upload_paparan_program_month`) as char(4400) charset utf8mb4) AS `hirarki`,0 AS `levels` from (`trx_upload_paparan_program` `a` left join `mst_work_units` `c` on(((`a`.`upload_paparan_program_work_unit_uuid` = `c`.`work_unit_uuid`) and (`c`.`work_unit_log_uuid` is null) and (`c`.`work_unit_status` = 1)))) where ((`a`.`upload_paparan_program_parent_uuid` = '0') and (`a`.`upload_paparan_program_status` = 1) and (`a`.`upload_paparan_program_log_uuid` is null) and (`a`.`upload_paparan_program_month` = (select max(`x`.`upload_paparan_program_month`) from `trx_upload_paparan_program` `x` where ((`x`.`upload_paparan_program_year` = `a`.`upload_paparan_program_year`) and (`x`.`upload_paparan_program_log_uuid` is null) and (`x`.`upload_paparan_program_status` = 1))))) union all select `a`.`upload_paparan_program_id` AS `upload_paparan_program_id`,`a`.`upload_paparan_program_uuid` AS `upload_paparan_program_uuid`,`a`.`upload_paparan_program_parent_uuid` AS `upload_paparan_program_parent_uuid`,`a`.`upload_paparan_program_work_unit_uuid` AS `upload_paparan_program_work_unit_uuid`,`a`.`upload_paparan_program_year` AS `upload_paparan_program_year`,`a`.`upload_paparan_program_month` AS `upload_paparan_program_month`,`a`.`upload_paparan_program_code` AS `upload_paparan_program_code`,`a`.`upload_paparan_program_name` AS `upload_paparan_program_name`,`a`.`upload_paparan_program_spd_pagu` AS `upload_paparan_program_spd_pagu`,`a`.`upload_paparan_program_spd_realisasi` AS `upload_paparan_program_spd_realisasi`,`a`.`upload_paparan_program_spd_target` AS `upload_paparan_program_spd_target`,`c`.`work_unit_code` AS `work_unit_code`,`c`.`work_unit_name` AS `work_unit_name`,concat(`b`.`tabs`,'___') AS `tabs`,concat(`b`.`hirarki`,':',convert((case when (`b`.`levels` >= 2) then concat(':',`a`.`upload_paparan_program_code`,':') else '' end) using utf8mb4),convert(`number_to_alphabet`(`a`.`upload_paparan_program_id`) using utf8mb4)) AS `hirarki`,(`b`.`levels` + 1) AS `b.levels + 1` from ((`trx_upload_paparan_program` `a` join `category_hierarchy` `b` on(((`a`.`upload_paparan_program_parent_uuid` = `b`.`upload_paparan_program_uuid`) and (`a`.`upload_paparan_program_year` = `b`.`upload_paparan_program_year`) and (`a`.`upload_paparan_program_month` = `b`.`upload_paparan_program_month`)))) left join `mst_work_units` `c` on(((`a`.`upload_paparan_program_work_unit_uuid` = `c`.`work_unit_uuid`) and (`c`.`work_unit_log_uuid` is null) and (`c`.`work_unit_status` = 1)))) where ((`a`.`upload_paparan_program_status` = 1) and (`a`.`upload_paparan_program_log_uuid` is null) and ((`b`.`levels` + 1) <= 2))) select `a`.`upload_paparan_program_year` AS `work_program_year`,`a`.`upload_paparan_program_work_unit_uuid` AS `work_unit_uuid`,`a`.`work_unit_code` AS `work_unit_code`,`a`.`work_unit_name` AS `work_unit_name`,`a`.`upload_paparan_program_spd_pagu` AS `budget_pagu`,`a`.`upload_paparan_program_spd_realisasi` AS `budget_realization` from `category_hierarchy` `a` where (`a`.`levels` in (0,2)) order by `a`.`hirarki`;
...
FROM trx_upload_paparan_program 
WHERE upload_paparan_program_year = tahun AND
upload_paparan_program_month <= 12
AND upload_paparan_program_status = 1
GROUP BY upload_paparan_program_year, upload_paparan_program_month
ORDER BY upload_paparan_program_month DESC
LIMIT 1;
...
-- 	a.upload_paparan_program_id,
	...
	c.work_unit_name,
	c.work_unit_sort,
	IFNULL( sum( a.upload_paparan_program_spd_pagu ), 0 ) AS plafon,
	IFNULL( sum( a.upload_paparan_program_spd_realisasi ), 0 ) AS realisasi 
FROM
	trx_upload_paparan_program a
	LEFT JOIN mst_work_units c ON a.upload_paparan_program_work_unit_uuid = c.work_unit_uuid 
	AND c.work_unit_log_uuid IS NULL 
	AND c.work_unit_status = 1 
WHERE
	a.upload_paparan_program_parent_uuid = '0' 
	AND a.upload_paparan_program_status = 1 
	AND a.upload_paparan_program_log_uuid IS NULL 
	AND a.upload_paparan_program_year = tahun AND a.upload_paparan_program_month = bulan_fix
