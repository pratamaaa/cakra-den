...
const themeSwitcher = function () {
    ...
    const layoutTheme = function () {
        ...
        function setTheme(e) {
            ...
            $('.chart_layout').each(function(){
                var ids = $(this).attr('id');
                console.log($('#'+ids).hasClass('highcharts-'+mode))
                if(!$('#'+ids).hasClass('highcharts-'+mode)){
                    if(mode=='dark'){
                        $('#'+ids).removeClass('highcharts-light');
                    }else{
                        $('#'+ids).removeClass('highcharts-dark');
                    }
                    
                    $('#'+ids).addClass('highcharts-'+mode);
                }

                //document.getElementById(ids).className = e.target.value === 'none' ? 'highcharts-light' : `highcharts-${e.target.value}`;
            })
