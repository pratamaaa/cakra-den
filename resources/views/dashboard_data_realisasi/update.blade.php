   ...
   <div class="content">
      ...
      <div class="card rounded-0 border shadow">
         <div class="card-header d-flex align-items-center py-0">
            <h6 class="py-3 mb-0 content_title">Form Update Data Dashboard Realisasi</h6>
         </div>
            ...
            <form class="form-validate" action="" method="POST" enctype="multipart/form-data">
               ...
               <div class="row mb-2">
                  ...
                  <div class="col-lg-9">
                     <div class="input-group mt-2">
                        <span class="input-group-text">Rp</span>
                        <input type="text" value="{{ $detail->dashboard_realisasi_pegawai }}" class="form-control wajib angka_doank" placeholder="" id="dashboard_realisasi_pegawai" name="dashboard_realisasi_pegawai" onkeyup="hitung_total(this)">
                     </div>
                  </div>
               </div>
               <div class="row mb-2">
                  ...
                  <div class="col-lg-9">
                     <div class="input-group mt-2">
                        <span class="input-group-text">Rp</span>
                        <input type="text" value="{{ $detail->dashboard_realisasi_barang }}" class="form-control wajib angka_doank" placeholder="" id="dashboard_realisasi_barang" name="dashboard_realisasi_barang" onkeyup="hitung_total(this)">
                     </div>
                  </div>
               </div>
               <div class="row mb-2">
                  ...
                  <div class="col-lg-9">
                     <div class="input-group mt-2">
                        <span class="input-group-text">Rp</span>
                        <input type="text" value="{{ $detail->dashboard_realisasi_modal }}" class="form-control wajib angka_doank" placeholder="" id="dashboard_realisasi_modal" name="dashboard_realisasi_modal" onkeyup="hitung_total(this)">
                     </div>
                  </div>
               </div>
               <div class="row mb-2">
