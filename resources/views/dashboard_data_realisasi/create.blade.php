   ...
   <div class="content">
      ...
      <div class="card rounded-0 border shadow">
         <div class="card-header d-flex align-items-center py-0">
            <h6 class="py-3 mb-0 content_title">Form Data Dashboard Realisasi</h6>
         </div>
         ...
         <div class="card-body">
            ...
            <form class="form-validate" action="" method="POST" enctype="multipart/form-data">
               ...
               <div class="row mb-2">
                  ...
                  <div class="col-lg-9">
                     <select class="form-control select wajib" data-placeholder="Tahun Anggaran" id="dashboard_realisasi_year" name="dashboard_realisasi_year" onchange="check_tahun(this)">
                        <option></option>
               ...
               <div class="is_revisi" style="display: none;">
                  <div class="row mb-2">
                     <label class="col-lg-3 col-form-label">Pagu Awal</label>
                     <div class="col-lg-9">
                        <div class="input-group mt-2">
                           <span class="input-group-text">Rp</span>
                           <input readonly type="text" value="{{ old('dashboard_realisasi_pagu_awal') }}" class="form-control angka_doank" placeholder="" id="dashboard_realisasi_pagu_awal" name="dashboard_realisasi_pagu_awal">
                        </div>
                     </div>
                  </div>
                  <div class="row mb-2">
               ...
               <div class="row mb-2">
                  ...
                  <div class="col-lg-9">
                     <div class="input-group mt-2">
                        <span class="input-group-text">Rp</span>
                        <input type="text" value="{{ old('dashboard_realisasi_pegawai') }}" class="form-control wajib angka_doank" placeholder="" id="dashboard_realisasi_pegawai" name="dashboard_realisasi_pegawai" onkeyup="hitung_total(this)">
                     </div>
                  </div>
               </div>
               <div class="row mb-2">
                  ...
                  <div class="col-lg-9">
                     <div class="input-group mt-2">
                        <span class="input-group-text">Rp</span>
                        <input type="text" value="{{ old('dashboard_realisasi_barang') }}" class="form-control wajib angka_doank" placeholder="" id="dashboard_realisasi_barang" name="dashboard_realisasi_barang" onkeyup="hitung_total(this)">
                     </div>
                  </div>
               </div>
               <div class="row mb-2">
                  ...
                  <div class="col-lg-9">
                     <div class="input-group mt-2">
                        <span class="input-group-text">Rp</span>
                        <input type="text" value="{{ old('dashboard_realisasi_modal') }}" class="form-control wajib angka_doank" placeholder="" id="dashboard_realisasi_modal" name="dashboard_realisasi_modal" onkeyup="hitung_total(this)">
                     </div>
                  </div>
               </div>
               <div class="row mb-2">
                  ...
                  <div class="col-lg-9">
                     <div class="input-group mt-2">
                        <span class="input-group-text">Rp</span>
                        <input readonly type="text" value="" class="form-control wajib angka_doank" placeholder="" id="dashboard_realisasi_total_belanja_temp" name="dashboard_realisasi_total_belanja_temp">
                        
                        <input readonly type="hidden" value="" class="form-control isnothidden" placeholder="" id="dashboard_realisasi_total_belanja" name="dashboard_realisasi_total_belanja">
                     </div>
                  </div>
               ...
               <div class="col-lg-6 offset-lg-3 mt-3">
                  ...
                  <input readonly type="hidden" value="" class="form-control" placeholder="" id="dashboard_realisasi_total" name="dashboard_realisasi_total">
