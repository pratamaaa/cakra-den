   ...
   <div class="content">
      ...
      <div class="card rounded-0 border shadow">
         <div class="card-header d-flex align-items-center py-0">
            <h6 class="py-3 mb-0 content_title">Penilaian Data Pendaftaran Ujian</h6>
         </div>
         ...
         <div class="card-body">
            ...
            <form class="form-validate" action="" method="POST" enctype="multipart/form-data">
               ...
               <div class="row mb-2">
                  <label class="col-lg-3 col-form-label">Kota Ujian <span class="text-danger">*</span></label>
                  <div class="col-lg-9">
                     <select class="form-control select wajib" data-placeholder="Kota Ujian" id="participant_test_city_uuid" name="participant_test_city_uuid" disabled>
                        <option></option>
                        @foreach ($kota_ujian as $row)
                           <option value="{{ $row->city_test_uuid }}" {{ $detail->participant_test_city_uuid == $row->city_test_uuid ? 'selected' : '' }}>{{ $row->city_test_name }}</option>
                        @endforeach
               ...
               <div class="row mb-2">
                  ...
                  <div class="col-lg-9">
                     <select class="form-control select wajib" data-placeholder="Lokasi Ujian" id="participant_location_test_uuid" name="participant_location_test_uuid" disabled>
                        <option></option>
                  ...
                  <div class="col-lg-9">
                     @foreach ($kelengkapan_dokumen as $row)
                        <label class="form-check mb-2">
                           <input type="checkbox" class="form-check-input form-check-input-success" {{ $row->ischeck > 0 ? 'checked' : '' }} onclick="set_berkas(this, {{ $row->kelengkapan_document_id }})" disabled>
               ...
               <div class="alert alert-primary alert-dismissible fade show pt-2 pb-2 rounded-0 mt-3">
                  <span class="fw-semibold">Proses Penilaian</span>
               </div>
               <div class="row mb-2">
                  <label class="col-lg-3 col-form-label">Status Ujian <span class="text-danger">*</span></label>
                  <div class="col-lg-9">
                     <select class="form-control select wajib" data-placeholder="Status Ujian" id="status" name="status" onchange="set_status(this)">
                        <option></option>
