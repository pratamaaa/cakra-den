...
@section('content')
         ...
         <div class="col-lg-12">
               ...
               <div class="col-sm-6 col-md-4 col-xl-4">
                  <div class="card card-body rounded-0 border-0">
                     ...
                     <div>
                        ...
                        Sampai Dengan <span class="hari_akhir"></span>
                     </div>
                  </div>
               </div>
            ...
            <div class="tab-content">
                           ...
                           <table class="table table-bordered" id="datatable-dataanggaran">
                              ...
                              <thead>
                                 <tr class="border-top-success">
                                    ...
                                    <th class="text-center border-success text-success bg-success bg-opacity-10 align-middle" style="" colspan="4">REALISASI DAN DEVIASI</th>
               ...
               <div class="tab-pane fade" id="js-tab2">
                  <div class="card rounded-0 border-0 shadow-0">
                     <div class="card-header d-flex align-items-center">
                        <h6 class="mb-0">Kurva-S</h6>
                        <div class="ms-auto">

                           <div class="input-group">
                              <span class="input-group-text">Tahun Anggaran</span>
                              <input type="text" class="form-control datepicker-default-view text-end" readonly placeholder="Tahun" value="{{ date('Y') }}" style="width: 130px" id="data_anggaran_tahun_kurva" name="data_anggaran_tahun_kurva" onchange="set_tahun_kurva(this)">
                           </div>
                        </div>
                     </div>
                     <div class="card-body">
               ...
               <div class="tab-pane fade" id="js-tab3">
                  <div class="card rounded-0 border-0 shadow-0">
                     <div class="card-header d-flex align-items-center">
                        <h6 class="mb-0">Detail Per-Belanja</h6>
                        <div class="ms-auto">
                           ...
                           <table class="table table-bordered" id="datatable-detailbelanja">
                              ...
                              <tfoot>
                                 <tr class="border-bottom-success">
                                    ...
                                    <td class="text-end border-success text-success bg-success bg-opacity-10 fw-semibold total_index_belanja_4">0</td>
               ...
               <div class="tab-pane fade" id="js-tab4">
                  <div class="card rounded-0 border-0 shadow-0">
                     <div class="card-header d-flex align-items-center">
                        <h6 class="mb-0">Diagram Realisasi</h6>
                        <div class="ms-auto">

                           <div class="input-group">
                              <span class="input-group-text">Tahun Anggaran</span>
                              <input type="text" class="form-control datepicker-default-view text-end" readonly placeholder="Tahun" value="{{ date('Y') }}" style="width: 130px" id="data_anggaran_tahun_diagram" name="data_anggaran_tahun_diagram" onchange="set_tahun_diagram(this)">
                           </div>
                        </div>
                     </div>
                     <div class="card-body">
                           ...
                           <div class="col-lg-3">
                              ...
                              <div class="card rounded-0 border shadow">
                                 ...
                                 <div class="card-body">
                                    ...
                                    <div class="sidebar-section-body">
                                       <label class="form-check form-check-reverse text-start mb-2">
                                          <input type="checkbox" class="form-check-input filter_target_diagram" value="1" checked>
                                          <span class="form-check-label">Target</span>
                                       </label>

                                       <label class="form-check form-check-reverse text-start mb-2">
                                          <input type="checkbox" class="form-check-input filter_target_diagram" value="2" checked>
                                          <span class="form-check-label">Realisasi</span>
                                       </label>
                                 ...
                                 <div class="card-body">
                                    ...
                                    <div class="sidebar-section-body">
                                       @foreach ($satker as $row)
                                          <label class="form-check form-check-reverse text-start mb-2">
                                             @if (!$loop->first)
                                                <input type="checkbox" class="form-check-input filter_satker_diagram" value="{{ $row->work_unit_uuid }}">
                                                <span class="form-check-label ps-3">{{ $row->work_unit_code }}</span>
                                             @else
                                                <input type="checkbox" class="form-check-input filter_satker_diagram" value="{{ $row->work_unit_uuid }}" checked>
                                                <span class="form-check-label">{{ $row->work_unit_code }}</span>
                                             @endif
                                          </label>
                                       @endforeach
   ...
   <script type="text/javascript">
      ...
      function set_tahun_detailbelanja(ini) {
         $('#datatable-detailbelanja').DataTable().ajax.reload();
      }

      $(document).ready(function() {
         const data_anggaran_tahun_kurva = document.querySelector('#data_anggaran_tahun_kurva');

         var dpDefaultView_data_anggaran_tahun_kurva = new Datepicker(data_anggaran_tahun_kurva, {
         ...
         const data_anggaran_tahun = document.querySelector('#data_anggaran_tahun');

         var dpDefaultView_data_anggaran_tahun = new Datepicker(data_anggaran_tahun, {
            container: '.content-inner',
            buttonClass: 'btn',
            prevArrow: document.dir == 'rtl' ? '&rarr;' : '&larr;',
            nextArrow: document.dir == 'rtl' ? '&larr;' : '&rarr;',
         ...
         const data_anggaran_tahun_detailbelanja = document.querySelector('#data_anggaran_tahun_detailbelanja');

         var dpDefaultView_data_anggaran_tahun_detailbelanja = new Datepicker(data_anggaran_tahun_detailbelanja, {
            container: '.content-inner',
            buttonClass: 'btn',
            prevArrow: document.dir == 'rtl' ? '&rarr;' : '&larr;',
            nextArrow: document.dir == 'rtl' ? '&larr;' : '&rarr;',
         ...
         datatableindex = $('#datatable-dataanggaran').dataTable({
            ...
            ajax: {
               url: baseurl + '/realisasianggaran/listdata_detailrealisasi',
               type: "POST",
               data: function(d) {
                  d._token = '{{ csrf_token() }}';
                  d.tahun = function() {
            ...
            "fnRowCallback": function(nRow, aData, iDisplayIndex, iDisplayIndexFull) {
               if (parseFloat(aData[7]) >= -3 && parseFloat(aData[7]) < 1) {
                  $('td', nRow).eq(7).attr('style', 'background-color: #f35c86 !important; color : white !important');
               } else if (parseFloat(aData[7]) >= -1 && parseFloat(aData[7]) < 3) {
                  $('td', nRow).eq(7).attr('style', 'background-color: #ffd648 !important; color : white !important');
               } else if (parseFloat(aData[7]) < 1) {
                  $('td', nRow).eq(7).attr('style', 'background-color: #059669 !important; color : white !important');
               } else {
                  $('td', nRow).eq(7).attr('style', 'background-color: #0c83ff !important; color : white !important');
               }
            ...
            drawCallback: function(settings) {
               ...
               var hari_terakhir = moment(response.gettanggal[0].hari_terakhir, "YYYY-MM-DD").format("DD MMM YYYY");

               $('.hari_akhir').html(hari_terakhir);
               ...
               for (let index = 0; index < data_api.length; index++) {
                  ...
                  // total_index_3 += (parseFloat(data_api[index][2].replace(/\./g, ''))/parseFloat(data_api[index][1].replace(/\./g, '')))*100.0;
                  ...
                  // total_index_8 += parseInt(data_api[index][8].replace(/\./g, ''));
               ...
               $('.total_index_6').html(new Intl.NumberFormat('id-ID').format(total_index_6.toFixed(2)));
               $('.total_index_7').html(new Intl.NumberFormat('id-ID').format(total_index_7.toFixed(2)));
               ...
               if (parseFloat(total_index_7) >= -3 && parseFloat(total_index_7) < 1) {
                  $('.total_index_7').attr('style', 'background-color : #f35c86 !important; color : white !important');
               } else if (parseFloat(total_index_7) >= -1 && parseFloat(total_index_7) < 3) {
                  $('.total_index_7').attr('style', 'background-color : #ffd648 !important; color : white !important');
               } else if (parseFloat(total_index_7) < 1) {
                  $('.total_index_7').attr('style', 'background-color : #059669 !important; color : white !important');
               } else {
                  $('.total_index_7').attr('style', 'background-color : #0c83ff !important; color : white !important');
         ...
         datatableindex2 = $('#datatable-detailbelanja').dataTable({
            autoWidth: false,
            responsive: false,
            fixedHeader: {
               header: true,
            ...
            ajax: {
               url: baseurl + '/realisasianggaran/listdata_detailbelanja',
               type: "POST",
               data: function(d) {
                  d._token = '{{ csrf_token() }}';
                  d.tahun = function() {
            ...
            drawCallback: function(settings) {
               ...
               var response = settings.json;
               var total_index_belanja_1 = 0;
               var total_index_belanja_2 = 0;
               var total_index_belanja_3 = 0;
               var total_index_belanja_4 = 0;
               var total_index_belanja_5 = 0;
               var total_index_belanja_6 = 0;
               var total_index_belanja_7 = 0;
               var total_index_belanja_8 = 0;
               ...
               $('.total_index_belanja_4').html(new Intl.NumberFormat('id-ID').format(total_index_belanja_4));
               $('.total_index_belanja_5').html(new Intl.NumberFormat('id-ID').format(total_index_belanja_5));
      ...
      function get_kurva_s() {
         ...
         var data_anggaran_tahun_kurva = $('#data_anggaran_tahun_kurva').val();
         $.ajax({
            ...
            data: {
               ...
               tahun: data_anggaran_tahun_kurva
            },
      ...
      $(document).ready(function() {
         ...
         $('.filter_target_diagram').click(function() {
            get_kurva_s()
         })
         $('.filter_satker_diagram').click(function() {

            if ($(this).is(':checked')) {
               $('.filter_satker_diagram[value!="' + $(this).val() + '"]').prop('checked', false); // Checks it
               get_kurva_s()
            }
         })
