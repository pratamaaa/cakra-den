   ...
   <div class="content">
      ...
      <div class="card rounded-0 border shadow">
         <div class="card-header d-flex align-items-center py-0">
            <h6 class="py-3 mb-0 content_title">Form Data Target Renkas</h6>
         </div>
                     ...
                     <table class="table table-bordered" id="datatable-detailbelanja">
                        <thead>
                           ...
                           <tr class="border-top-success">
                              ...
                              <th class="text-center border-success text-success align-top" style="">
                                 <input type="text" class="form-control wajib angka_doank" placeholder="" value="" id="target_month_{{ $row->work_unit_id }}_1" name="target_month_{{ $row->work_unit_id }}_1" data_wo_id="{{ $row->work_unit_id }}" data_idx="1" onchange="check_value(this)">
                              </th>
                              <th class="text-center border-success text-success align-top" style="">
                                 <input type="text" class="form-control wajib angka_doank" placeholder="" value="" id="target_month_{{ $row->work_unit_id }}_2" name="target_month_{{ $row->work_unit_id }}_2" data_wo_id="{{ $row->work_unit_id }}" data_idx="2" onchange="check_value(this)">
                              </th>
                              <th class="text-center border-success text-success align-top" style="">
                                 <input type="text" class="form-control wajib angka_doank" placeholder="" value="" id="target_month_{{ $row->work_unit_id }}_3" name="target_month_{{ $row->work_unit_id }}_3" data_wo_id="{{ $row->work_unit_id }}" data_idx="3" onchange="check_value(this)">
                              </th>
                              <th class="text-center border-success text-success align-top" style="">
                                 <input type="text" class="form-control wajib angka_doank" placeholder="" value="" id="target_month_{{ $row->work_unit_id }}_4" name="target_month_{{ $row->work_unit_id }}_4" data_wo_id="{{ $row->work_unit_id }}" data_idx="4" onchange="check_value(this)">
                              </th>
                              <th class="text-center border-success text-success align-top" style="">
                                 <input type="text" class="form-control wajib angka_doank" placeholder="" value="" id="target_month_{{ $row->work_unit_id }}_5" name="target_month_{{ $row->work_unit_id }}_5" data_wo_id="{{ $row->work_unit_id }}" data_idx="5" onchange="check_value(this)">
                              </th>
                              <th class="text-center border-success text-success align-top" style="">
                                 <input type="text" class="form-control wajib angka_doank" placeholder="" value="" id="target_month_{{ $row->work_unit_id }}_6" name="target_month_{{ $row->work_unit_id }}_6" data_wo_id="{{ $row->work_unit_id }}" data_idx="6" onchange="check_value(this)">
                              </th>
                              <th class="text-center border-success text-success align-top" style="">
                                 <input type="text" class="form-control wajib angka_doank" placeholder="" value="" id="target_month_{{ $row->work_unit_id }}_7" name="target_month_{{ $row->work_unit_id }}_7" data_wo_id="{{ $row->work_unit_id }}" data_idx="7" onchange="check_value(this)">
                              </th>
                              <th class="text-center border-success text-success align-top" style="">
                                 <input type="text" class="form-control wajib angka_doank" placeholder="" value="" id="target_month_{{ $row->work_unit_id }}_8" name="target_month_{{ $row->work_unit_id }}_8" data_wo_id="{{ $row->work_unit_id }}" data_idx="8" onchange="check_value(this)">
                              </th>
                              <th class="text-center border-success text-success align-top" style="">
                                 <input type="text" class="form-control wajib angka_doank" placeholder="" value="" id="target_month_{{ $row->work_unit_id }}_9" name="target_month_{{ $row->work_unit_id }}_9" data_wo_id="{{ $row->work_unit_id }}" data_idx="9" onchange="check_value(this)">
                              </th>
                              <th class="text-center border-success text-success align-top" style="">
                                 <input type="text" class="form-control wajib angka_doank" placeholder="" value="" id="target_month_{{ $row->work_unit_id }}_10" name="target_month_{{ $row->work_unit_id }}_10" data_wo_id="{{ $row->work_unit_id }}" data_idx="10" onchange="check_value(this)">
                              </th>
                              <th class="text-center border-success text-success align-top" style="">
                                 <input type="text" class="form-control wajib angka_doank" placeholder="" value="" id="target_month_{{ $row->work_unit_id }}_11" name="target_month_{{ $row->work_unit_id }}_11" data_wo_id="{{ $row->work_unit_id }}" data_idx="11" onchange="check_value(this)">
                              </th>
                              <th class="text-center border-success text-success align-top" style="">
                                 <input type="text" class="form-control wajib angka_doank" placeholder="" value="" id="target_month_{{ $row->work_unit_id }}_12" name="target_month_{{ $row->work_unit_id }}_12" data_wo_id="{{ $row->work_unit_id }}" data_idx="12" onchange="check_value(this)">
                              </th>
                           </tr>
                           @endforeach
