    ...
    <div class="offcanvas-body p-0">
       ...
       <div class="p-3">
          <div class="d-flex align-items-start mb-3">
             ...
             <div class="flex-fill">
                <a href="javascript:void(0)" class="fw-semibold">James</a> has completed the task <a href="javascript:void(0)">Submit documents</a> from <a href="javascript:void(0)">Onboarding</a> list
          ...
          <div class="d-flex align-items-start mb-3">
             ...
             <div class="flex-fill">
                <a href="javascript:void(0)" class="fw-semibold">Margo</a> has added 4 users to <span class="fw-semibold">Customer enablement</span> channel

                <div class="d-flex my-2">
                   <a href="javascript:void(0)" class="status-indicator-container me-1">
       ...
       <div class="p-3">
          <div class="d-flex align-items-start mb-3">
             ...
             <div class="flex-fill">
                <a href="javascript:void(0)" class="fw-semibold">Nick</a> requested your feedback and approval in support request <a href="javascript:void(0)">#458</a>

                <div class="my-2">
                   <a href="javascript:void(0)" class="btn btn-success btn-sm me-1">
          ...
          <div class="d-flex align-items-start mb-3">
             ...
             <div class="flex-fill">
                <a href="javascript:void(0)" class="fw-semibold">Mike</a> added 1 new file(s) to <a href="javascript:void(0)">Product management</a> project
          ...
          <div class="d-flex align-items-start mb-3">
             ...
             <div class="flex-fill">
                <a href="javascript:void(0)" class="fw-semibold">Christine</a> commented on your community <a href="javascript:void(0)">post</a> from 10.12.2021
