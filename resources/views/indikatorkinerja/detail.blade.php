   ...
   <div class="content">
      ...
      <div class="card rounded-0 border shadow">
         <div class="card-header d-flex align-items-center py-0">
            <h6 class="py-3 mb-0 content_title">Form Detail Data Indikator Kinerja</h6>
         </div>
         ...
         <div class="card-body">
            ...
            <form class="form-validate" action="" method="POST" enctype="multipart/form-data">
               ...
               <div class="row mb-2">
                  ...
                  <div class="col-lg-9">
                     <input type="text" class="form-control picker_tahun wajib" disabled placeholder="Tahun" value="{{ $detail->sasaran_strategis_year }}" id="sasaran_strategis_year" name="sasaran_strategis_year" onchange="get_ss(this)">
                  </div>
               </div>
               <div class="row mb-2">
                  <label class="col-lg-3 col-form-label">Sasaran Strategis <span class="text-danger">*</span></label>
                  <div class="col-lg-9">
                     <select class="form-control select wajib" disabled data-placeholder="Sasaran Strategis" id="indikator_kinerja_sasaran_strategis_uuid" name="indikator_kinerja_sasaran_strategis_uuid" data-value="{{ $detail->indikator_kinerja_sasaran_strategis_uuid }}">
                        <option></option>
                     </select>
                  </div>
               </div>
               <div class="row mb-2">
                  ...
                  <div class="col-lg-9">
                     <input type="text" class="form-control wajib" disabled placeholder="Indikator Kinerja" value="{{ $detail->indikator_kinerja_name }}" id="indikator_kinerja_name" name="indikator_kinerja_name">
                  </div>
               </div>
               <div class="row mb-2">
                  <label class="col-lg-3 col-form-label">Satuan <span class="text-danger">*</span></label>
                  <div class="col-lg-9">
                     <input type="text" class="form-control wajib" disabled placeholder="Satuan" value="{{ $detail->indikator_kinerja_satuan }}" id="indikator_kinerja_satuan" name="indikator_kinerja_satuan">
                  </div>
               </div>
               <div class="row mb-2">
                  <label class="col-lg-3 col-form-label">Target <span class="text-danger">*</span></label>
                  <div class="col-lg-9">
                     <input type="text" class="form-control wajib" disabled placeholder="Target" value="{{ $detail->indikator_kinerja_target }}" id="indikator_kinerja_target" name="indikator_kinerja_target">
                  </div>
               </div>
