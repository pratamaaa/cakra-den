   ...
   <div class="content">
      ...
      <div class="card rounded-0 border shadow">
         <div class="card-header d-flex align-items-center py-0">
            <h6 class="py-3 mb-0 content_title">Daftar Data Indikator Kinerja</h6>
            <div class="ms-auto my-auto">
               <a href="{{ url('indikatorkinerja/create') }}" class="btn btn-flat-primary btn-outline-primary">
                  <i class="ph-plus me-2"></i>
                  Tambah Data Indikator Kinerja
               </a>
            </div>
         </div>
   ...
   <script type="text/javascript">
      ...
      $(document).ready(function() {
         ...
         datatableindex = $('#datatable-index').dataTable({
            ...
            responsive: true,
            ajax: {
               url: baseurl + '/indikatorkinerja/list',
               type: "POST",
               data: function(d) {
                  d._token = '{{ csrf_token() }}';
