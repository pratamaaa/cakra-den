         ...
         <div class="card-body">
            ...
            <form class="form-validate" action="" method="POST" enctype="multipart/form-data">
               ...
               <div class="row mb-2">
                  ...
                  <div class="col-lg-9">
                     <input type="text" class="form-control picker_tahun wajib" readonly placeholder="Tahun" value="{{ date('Y') }}" id="sasaran_strategis_year" name="sasaran_strategis_year" onchange="get_ss(this)">
                  </div>
               </div>
               <div class="row mb-2">
                  <label class="col-lg-3 col-form-label">Sasaran Strategis <span class="text-danger">*</span></label>
                  <div class="col-lg-9">
                     <select class="form-control select wajib" data-placeholder="Sasaran Strategis" id="indikator_kinerja_sasaran_strategis_uuid" name="indikator_kinerja_sasaran_strategis_uuid">
                        <option></option>
                     </select>
                  </div>
               </div>
               <div class="row mb-2">
                  ...
                  <div class="col-lg-9">
                     <input type="text" class="form-control wajib" placeholder="Indikator Kinerja" value="" id="indikator_kinerja_name" name="indikator_kinerja_name">
                  </div>
               </div>
               <div class="row mb-2">
                  <label class="col-lg-3 col-form-label">Satuan <span class="text-danger">*</span></label>
                  <div class="col-lg-9">
                     <input type="text" class="form-control wajib" placeholder="Satuan" value="" id="indikator_kinerja_satuan" name="indikator_kinerja_satuan">
                  </div>
               </div>
               <div class="row mb-2">
                  <label class="col-lg-3 col-form-label">Target <span class="text-danger">*</span></label>
                  <div class="col-lg-9">
                     <input type="text" class="form-control wajib" placeholder="Target" value="" id="indikator_kinerja_target" name="indikator_kinerja_target">
                  </div>
               </div>
            ...
            success: function(data) {
               ...
               if (data != null) {
                  for (var i = 0; i < data.length; i++) {
                     ...
                     NewHtml += '<option value="' + data[i].sasaran_strategis_uuid + '">' + data[i].sasaran_strategis_name + '</option>';
                  }
