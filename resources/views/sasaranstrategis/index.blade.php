...
@section('content')
   <div class="content">
      ...
      <div class="card rounded-0 border shadow">
         <div class="card-header d-flex align-items-center py-0">
            <h6 class="py-3 mb-0 content_title">Daftar Data Sasaran Strategis</h6>
            <div class="ms-auto my-auto">
               <a href="{{ url('sasaranstrategis/create') }}" class="btn btn-flat-primary btn-outline-primary">
                  <i class="ph-plus me-2"></i>
                  Tambah Data Sasaran Strategis
               </a>
            </div>
         </div>
         ...
         <div class="card-body">
            <div class="row mb-2">
               ...
               <div class="col-lg-10">
                  <select class="form-control select wajib" data-placeholder="Tahun Anggaran" id="sasaran_strategis_year" name="sasaran_strategis_year">
                     <option></option>
   ...
   <script type="text/javascript">
      ...
      function cari(jenis) {
         var sasaran_strategis_year = $('#sasaran_strategis_year').val();
      ...
      $(document).ready(function() {
         ...
         datatableindex = $('#datatable-index').dataTable({
            ...
            responsive: true,
            ajax: {
               url: baseurl + '/sasaranstrategis/list',
               type: "POST",
               data: function(d) {
                  d._token = '{{ csrf_token() }}';
