   ...
   <div class="content">
      ...
      <div class="card rounded-0 border shadow">
         <div class="card-header d-flex align-items-center py-0">
            <h6 class="py-3 mb-0 content_title">Form Detail Data Sasaran Strategis</h6>
         </div>
         ...
         <div class="card-body">
            ...
            <form class="form-validate" action="" method="POST" enctype="multipart/form-data">
               ...
               <div class="row mb-2">
                  ...
                  <div class="col-lg-9">
                     <input type="text" class="form-control picker_tahun wajib" readonly placeholder="Tahun" value="{{ $detail->sasaran_strategis_year }}" id="sasaran_strategis_year" name="sasaran_strategis_year">
                  </div>
               </div>
               {{-- <div class="row mb-2">
               ...
               <div class="row mb-2">
                  ...
                  <div class="col-lg-9">
                     <input type="text" class="form-control wajib" disabled placeholder="Sasaran Strategis" value="{{ $detail->sasaran_strategis_name }}" id="sasaran_strategis_name" name="sasaran_strategis_name">
                  </div>
               </div>
               ...
               <div class="col-lg-6 offset-lg-3 mt-3">
                  ...
                  <input type="hidden" name="sasaran_strategis_uuid" id="sasaran_strategis_uuid" value="{{ $detail->sasaran_strategis_uuid }}">
